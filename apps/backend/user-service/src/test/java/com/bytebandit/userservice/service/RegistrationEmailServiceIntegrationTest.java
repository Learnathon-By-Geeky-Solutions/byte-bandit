...
class RegistrationEmailServiceIntegrationTest {
     ...
     *     <li>The email body is generated by the {@link SpringTemplateEngine} and correctly injected into the email.</li>
     *     <li>The {@link SpringTemplateEngine#process} method is invoked with the expected template path and context.</li>
     * </ul>
     *
     * <p>Dependencies:</p>
     * <ul>
     *     <li>{@link GreenMailExtension} is used to simulate an SMTP server for capturing sent emails.</li>
     *     <li>{@link ReflectionTestUtils} is used to inject values into {@code backendHost} and {@code apiPrefix}, which are required to build the confirmation URL inside the service.</li>
     * </ul>
     *
